...
def save_as_volume(mri, us, dist, basename):
    np.savez(os.path.join(dist, f"MRI_US_ID{basename}_VOL"),
             mri=mri,
             us=us
             )
...
def process_image(args):
    ...
    save_as_volume(mri_data, us_data, dist, image_id)
